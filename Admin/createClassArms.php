       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Stages Subject</h1>
            <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Stage & Group<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--Stage & Group--</option>';
                      ...
                      <input type="text" class="form-control" name="classArmName" value="<?php echo $row['classArmName'];?>" id="exampleInputFirstName" placeholder="Subject">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Class Subject</h6>
                </div>
